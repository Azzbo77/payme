...
#[openapi(
    paths(
        ...
        crate::handlers::months::get_payday,
        crate::handlers::months::set_payday,
        crate::handlers::months::get_payday_mode_enabled,
        crate::handlers::months::set_payday_mode_enabled,
